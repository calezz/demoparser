...
fn main() {
    ...
    let settings = ParserInputs {
        ...
        wanted_event: Some("weapon_fire".to_string()),
        ...
        parse_ents: true,
        wanted_ticks: vec![10000, 10001, 10002],
    ...
    let v = vec![
        ...
        MinMaxTestEntry {
            min: 0,
            max: 32000,
            prop_name: "CCSPlayerController.m_pInGameMoneyServices.m_iAccount".to_string(),
